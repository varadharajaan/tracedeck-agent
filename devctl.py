...
def cmd_test(args: argparse.Namespace) -> int:
    ...
    if target == "smoke":
        ...
        run(powershell("./scripts/local/smoke-phase89.ps1"))
    elif target == "newman89":
        ...
        run(powershell("./scripts/local/smoke-phase92.ps1"))
    elif target == "newman92":
        ...
        run(powershell("./scripts/verify/verify-phase95.ps1"), stream=True)
    elif target == "verify95":
        run(powershell("./scripts/verify/verify-phase95.ps1"))
    elif target == "phase96":
        run(powershell("./scripts/verify/verify-phase96.ps1"), stream=True)
    elif target == "verify96":
        ...
        run(powershell("./scripts/verify/verify-phase98.ps1"), stream=True)
    elif target == "smoke98":
        run(powershell("./scripts/local/smoke-phase98.ps1"))
    elif target == "newman98":
    ...
    elif target == "phase101":
        run(powershell("./scripts/verify/verify-phase101.ps1"), stream=True)
    elif target == "verify101":
        run(powershell("./scripts/verify/verify-phase101.ps1"))
    elif target == "phase102":
        run(powershell("./scripts/verify/verify-phase102.ps1"), stream=True)
    elif target == "smoke102":
        run(powershell("./scripts/local/smoke-phase102.ps1"))
    elif target == "newman102":
    ...
    elif target == "phase107":
        run(powershell("./scripts/verify/verify-phase107.ps1"), stream=True)
    elif target == "verify107":
        run(powershell("./scripts/verify/verify-phase107.ps1"))
    elif target == "phase108":
        run(powershell("./scripts/verify/verify-phase108.ps1"), stream=True)
    elif target == "smoke108":
        run(powershell("./scripts/local/smoke-phase108.ps1"))
    elif target == "newman108":
        run(powershell("./scripts/local/newman-phase108.ps1"))
    elif target == "verify108":
        run(powershell("./scripts/verify/verify-phase108.ps1"))
    elif target == "phase109":
        run(powershell("./scripts/verify/verify-phase109.ps1"), stream=True)
    elif target == "smoke109":
        run(powershell("./scripts/local/smoke-phase109.ps1"))
    elif target == "newman109":
        run(powershell("./scripts/local/newman-phase109.ps1"))
    elif target == "verify109":
        run(powershell("./scripts/verify/verify-phase109.ps1"))
    elif target == "phase110":
        run(powershell("./scripts/verify/verify-phase110.ps1"), stream=True)
    elif target == "smoke110":
        run(powershell("./scripts/local/smoke-phase110.ps1"))
    elif target == "newman110":
        run(powershell("./scripts/local/newman-phase110.ps1"))
    elif target == "verify110":
        run(powershell("./scripts/verify/verify-phase110.ps1"))
    elif target == "phase111":
        run(powershell("./scripts/verify/verify-phase111.ps1"), stream=True)
    elif target == "smoke111":
        run(powershell("./scripts/local/smoke-phase111.ps1"))
    elif target == "newman111":
...
def cmd_audit(args: argparse.Namespace) -> int:
    run(powershell("./scripts/local/get-contract-completion-audit.ps1"), stream=True)
    return 0
...
def main() -> int:
    ...
    audit = sub.add_parser("audit", help="Write metadata-only contract completion audit")
