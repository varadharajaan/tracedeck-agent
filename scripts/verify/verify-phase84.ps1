...
Initialize-TraceDeckScriptLog -Name "verify-phase84" -LogRoot "logs/local/verify" | Out-Null
...
try {
    ...
    Invoke-TraceDeckLoggedCommand -Label "Dashboard JavaScript syntax check" -Command {
        powershell -NoProfile -ExecutionPolicy Bypass -File ./scripts/local/test-dashboard-js.ps1 -OutputRoot "data/local/dashboard-js-check/phase84/dashboard"
    }
    Invoke-TraceDeckLoggedCommand -Label "Browser activity JavaScript syntax check" -Command {
        powershell -NoProfile -ExecutionPolicy Bypass -File ./scripts/local/test-dashboard-js.ps1 -DashboardPath "backend/internal/api/web/browser_activity.html" -OutputRoot "data/local/dashboard-js-check/phase84/browser-activity"
    }
    ...
    Invoke-TraceDeckLoggedCommand -Label "Phase 84 modern UI smoke" -Command {
        powershell -NoProfile -ExecutionPolicy Bypass -File ./scripts/local/smoke-phase84.ps1
    }
    Invoke-TraceDeckLoggedCommand -Label "Phase 84 Newman collection" -Command {
    ...
    Invoke-TraceDeckLoggedCommand -Label "Dashboard visual quality contract" -Command {
        powershell -NoProfile -ExecutionPolicy Bypass -File ./scripts/local/test-dashboard-visual-quality.ps1 -OutputRoot "data/local/dashboard-visual-quality/phase84"
    }
    Invoke-TraceDeckLoggedCommand -Label "Dashboard theme contract" -Command {
        powershell -NoProfile -ExecutionPolicy Bypass -File ./scripts/local/test-dashboard-theme.ps1 -OutputRoot "data/local/dashboard-theme/phase84"
    }
    Invoke-TraceDeckLoggedCommand -Label "Dashboard layout contract" -Command {
        powershell -NoProfile -ExecutionPolicy Bypass -File ./scripts/local/test-dashboard-layout.ps1 -OutputRoot "data/local/dashboard-layout/phase84"
    }
    Invoke-TraceDeckLoggedCommand -Label "Lambda frontend visual contract" -Command {
        powershell -NoProfile -ExecutionPolicy Bypass -File ./scripts/local/test-lambda-frontend-visual.ps1 -OutputRoot "data/local/lambda-frontend-visual/phase84"
    }
